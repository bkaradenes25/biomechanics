...
sns.scatterplot(data=df, x='release_y', y='release_z', hue='pitcher_id', palette='tab10', legend = False)
plt.title("Release Point (Z vs Y)")
plt.xlabel("Release Y (left/right)")
...
# Top view (x vs. y)
plt.figure(figsize=(8, 6))
sns.scatterplot(data=df, x='release_y', y='release_x', hue='pitcher_id', palette='tab10', legend=False)
plt.title("Release Point (X vs Y)")
plt.xlabel("Release Y (left/right)")
plt.ylabel("Release X (toward/away from catcher)")
plt.legend(bbox_to_anchor=(1.05, 1), loc = 'upper left')
plt.tight_layout()
plt.show()
...
sns.scatterplot(data = merged_df, x = 'shoulder_angle', y = 'release_z', hue = 'pitcher_id', palette = 'tab10', legend = False)
...
plt.figure(figsize=(8, 6))
sns.scatterplot(data = merged_df, x = 'elbow_angle', y = 'release_z', hue = 'pitcher_id', palette = 'tab10', legend = False)
plt.title("Elbow Angle vs Release Height (Z)")
